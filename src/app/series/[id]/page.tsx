  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="relative w-full h-[70vh] md:h-[85vh]">
        ...
        <img 
          src={series.backdropUrl || series.posterUrl || "https://via.placeholder.com/1920x1080?text=No+Backdrop"} 
          alt={series.title}
        ...
        <div className="absolute bottom-0 left-0 z-20 p-4 md:p-12 w-full max-w-7xl flex flex-col md:flex-row gap-8 items-end">
          <div className="hidden md:block w-64 shrink-0 rounded-xl overflow-hidden shadow-2xl border border-white/10 glass-card">
            <img 
              src={series.posterUrl || "https://via.placeholder.com/500x750?text=No+Poster"} 
              alt={series.title}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              <button className="w-12 h-12 rounded-full border border-gray-400 bg-[#2a2a2a]/50 text-white flex items-center justify-center hover:border-white transition-colors backdrop-blur-md">
